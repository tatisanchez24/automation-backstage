...
import {
  ValidateMaxNumberCharacters,
  maxNumberCharactersValidation,
} from '../custom-fields/ValidateMaxNumberCharactersExtension';

export const ValidateMaxNumberCharactersFieldExtension =
  scaffolderPlugin.provide(
    createScaffolderFieldExtension({
      name: 'ValidateMaxNumberCharacters',
      component: ValidateMaxNumberCharacters,
      validation: maxNumberCharactersValidation,
    }),
  );
